...
The article's conclusion — that AI is causing juniors to fail to become seniors — is where I think it overshoots.
...
The Fluency Mask — Ekrem's term for AI's verbal fluency about code being mistaken for understanding of code — is real. But it's a trap that only closes on someone who isn't watching for it. The senior's job has always been to teach juniors to watch for exactly that kind of thing: confident outputs that feel like understanding but aren't grounded in anything. Stack Overflow answers with high vote counts. Code that compiles. Documentation that reads clearly but documents the wrong thing. AI is a new instance of an old problem.

---

## What This Has to Do With My Son

My son will grow up in a world where AI is as ambient as the internet was for my generation. He won't know a time without it. The question isn't whether he'll use it — he will, and he should — but whether he'll use it well or badly.

The distinction I want him to carry is this: AI is a tool to resolve a specific gap, not a replacement for developing the judgment to know where the gap is. The sequence matters. *Think first. Reach when stuck. Understand what you got back.* Inverting it — prompt first, think never — is where the damage happens.

But wanting him to have that understanding and actually building it in him are different things. The article's point about apprenticeship is the useful part here. The only known mechanism for transferring tacit knowledge is proximity to someone who has it, while they're using it. You don't teach a junior to smell a bad abstraction by explaining what bad abstractions are. You sit next to them while you read one, and you think out loud.

For a parent, that's the frame. I am the senior. The question is how I structure his relationship with hard problems before AI becomes his default move.

---

## Building the Muscle Before the Crutch
...
The way to build that tolerance is not by explaining it. It's by not rescuing him. When he's stuck, the temptation is to solve it. Resist it. Sit with him in the stuck. Ask questions that point at the problem without resolving it. Let him feel the friction of working through something. That discomfort is the exercise. Skipping it is skipping the rep.

When AI is in the picture, I want to use it with him, out loud, narrating why I'm reaching for it. "I know what I want here but I've forgotten the syntax — I'll check" is different from "I don't know what I want yet, so I need to think before I ask anything." He needs to see that distinction made consciously, by someone he trusts, before it becomes instinct. The failure mode isn't using AI — it's using AI to avoid the feeling of being stuck. The feeling of being stuck is where the learning lives.

---

## Teaching Him to Verify

The Fluency Mask is the thing I most want him to be inoculated against. AI produces confident, articulate, plausible explanations that have no necessary relationship to ground truth. The fluency is real; the grounding isn't. Learning to distrust fluency — in AI output, in Stack Overflow answers, in documentation, in his own explanations — is a skill that transfers everywhere.

The mechanism for building it is simple: ask him to explain things back. Not as a test. As genuine curiosity. After he's worked through something, "how does that work?" said as if I actually want to know. The act of explanation forces him to consolidate what he actually understood versus what he pattern-matched. The gaps surface immediately. He'll say something and pause because he doesn't actually know why it works that way. That pause is the whole point — recognising it as a gap rather than papering over it with fluent-sounding words is the habit I want him to have.

---

## Domains Where There Are No Shortcuts

This is the part the article doesn't say but implies: expose him to domains where AI is useless and the embodied learning is the only path.

Physical skills. Music. Sport. Cooking. Any domain where you have to do it badly for a long time before you do it less badly, and where no amount of reading about it substitutes for the doing. The lesson isn't domain-specific. It's structural: there exist things you cannot shortcut. A kid who's learned an instrument or spent years in a sport already has a gut understanding of Polanyi's point — they know what it feels like to know something in the body before they can articulate it. That intuition is protective. It generalises.
...
Ekrem notes that the seniors who matter most right now are "tacit translators" — people who can take something they feel before they can name it and do the slow, painful work of pulling it partway into the explicit. Most translations are partial. That's fine. Partial is better than nothing. And watching someone do that translation in real time — watching them sit with a thing they can't explain yet and not give up on explaining it — is itself the lesson.

---

## The Point

Ekrem's conclusion is right: *we can know more than we can tell, and that part of knowledge can only be transmitted by working alongside someone who has it*.

Where I'd adjust the framing: the threat isn't AI. The threat is the absence of people willing to do the slow work of the apprenticeship model — to let juniors watch them think, to push back on "I don't know why but trust me," to pair and review and explain. AI makes the shortcut more available and more seductive. But the shortcut was always there. The question was always whether someone cared enough to make you take the longer road.

For my son, that's the job. Not to keep him away from AI — that ship has sailed and the destination is fine — but to make sure he gets enough reps on the longer road first that he knows what the longer road feels like, and why it's worth walking.

The kids who figure that out will be the ones the next generation of teams desperately needs. Whether we call them seniors, tacit knowledge carriers, or just "the ones who actually understand what they're doing" is beside the point.
