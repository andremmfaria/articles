...
![Overall setup with the UDM, OPNsense box, and UniFi switch](overall-network-lab-setup.jpg)
...
![Create lagg device](create-lagg-device.png)
...
![Assign new interface](assign-new-interface.png)
...
![Interface assignments](interface-assignments.png)
...
![Bridge device](bridge-device.png)
...
![Bridge Interface](bridge-interface.png)
...
![UDM with WAN + two LACP ports (7 and 8) connected](udm-wan-and-lacp-ports.jpg)
...
![UniFi switch with aggregated ports 7 and 8 plus the rest of the network devices](unifi-switch-aggregated-ports.jpg)
...
![Cool graph](opnsense-traffic-graph.png)
